...
public:
    ...
    // named constructors
    static Location from_ekf_offset_NED_m(const Vector3f& ekf_offset_ned_m, AltFrame frame) { return Location(); }
    static Location from_ekf_offset_NED_m(const Vector3d& ekf_offset_ned_m, AltFrame frame) { return Location(); };
